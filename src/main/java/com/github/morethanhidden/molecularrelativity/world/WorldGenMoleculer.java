package com.github.morethanhidden.molecularrelativity.world;
...
public class WorldGenMoleculer implements  IWorldGenerator{
	...
	private void generateSurface(World world, Random rand, int chunkX, int chunkZ) {
		for(int i = 0; i < 10; i++){
			...
			(new WorldGenMinable(MainRegistry.telluriumOre, 5)).generate(world, rand, randPosX, randPosY, randPosZ);
		}
		}
